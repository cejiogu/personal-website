...
const About = () => {
  return(
    <React.Fragment>
      <div className="text" style={{paddingLeft: "30px", fontSize: "18px"}}>
        <h2> My Journey</h2>
      ...
      <div className="organizations">
        ...
        <Organization name="ColorStack" img='' position='Active Member' desc="I am an active member of the national organization 'ColorStack.'" /> */}
          ...
          <Organization name="National Society of Black Engineers" img={NSBElogo} />
          <Organization name="Underrepresented Minorities in Computing" img={URMClogo} />
          <Organization name="ColorStack" img={ColorStacklogo} />
        </div>
